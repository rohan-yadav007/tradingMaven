...
export const QUANTUM_SCALPER_TIMEFRAME_SETTINGS: Record<string, Partial<AgentParams>> = {
    ...
    '1m':  { qsc_adxThreshold: 32, qsc_rsiMomentumThreshold: 65, qsc_rsiOverextendedLong: 85, qsc_rsiOverextendedShort: 15, qsc_trendScoreThreshold: 88 },
    '3m':  { qsc_adxThreshold: 30, qsc_rsiMomentumThreshold: 62, qsc_rsiOverextendedLong: 82, qsc_rsiOverextendedShort: 18, qsc_trendScoreThreshold: 85 },
    '5m':  { qsc_adxThreshold: 28, qsc_rsiMomentumThreshold: 60, qsc_rsiOverextendedLong: 80, qsc_rsiOverextendedShort: 20, qsc_trendScoreThreshold: 80 },
    // Day Trading: More conservative thresholds to avoid chasing local tops/bottoms
    '15m': { qsc_adxThreshold: 25, qsc_rsiMomentumThreshold: 58, qsc_rsiOverextendedLong: 78, qsc_rsiOverextendedShort: 22, qsc_trendScoreThreshold: 78 },
    '30m': { qsc_adxThreshold: 23, qsc_rsiMomentumThreshold: 55, qsc_rsiOverextendedLong: 75, qsc_rsiOverextendedShort: 25, qsc_trendScoreThreshold: 75 },
    '1h':  { qsc_adxThreshold: 22, qsc_rsiMomentumThreshold: 55, qsc_rsiOverextendedLong: 72, qsc_rsiOverextendedShort: 28, qsc_trendScoreThreshold: 70 },
    // Swing Trading: Looser thresholds to catch trends early
    '4h':  { qsc_adxThreshold: 20, qsc_rsiMomentumThreshold: 52, qsc_rsiOverextendedLong: 70, qsc_rsiOverextendedShort: 30, qsc_trendScoreThreshold: 68 },
    '1d':  { qsc_adxThreshold: 20, qsc_rsiMomentumThreshold: 52, qsc_rsiOverextendedLong: 70, qsc_rsiOverextendedShort: 30, qsc_trendScoreThreshold: 65 },
};
