...
export const SENTINEL_TIMEFRAME_SETTINGS: Record<string, Partial<AgentParams>> = {
    ...
    '1m':  { sentinel_scoreThreshold: 90, sentinel_adxPeriod: 10, sentinel_rsiPeriod: 10, viPeriod: 10, sentinel_strongTrendAdx: 35, sentinel_strongTrendThreshold: 75, sentinel_choppyTrendAdx: 25, sentinel_choppyTrendThreshold: 90, sentinel_rsiOverextendedLong: 70, sentinel_rsiOverextendedShort: 30, sentinel_stPeriod: 10, sentinel_stMultiplier: 2.5, sentinel_bbwSqueezeThreshold: 0.0045, sentinel_emaFastPeriod: 21, sentinel_emaSlowPeriod: 50, sentinel_emaDistanceVetoThreshold: 1.8, sentinel_srZoneAtrBuffer: 1.2, sentinel_invalidationCandleLimit: 30, sentinel_rsiMomentumExitLong: 45, sentinel_rsiMomentumExitShort: 55 },
    ...
    '5m':  { sentinel_scoreThreshold: 80, sentinel_adxPeriod: 12, sentinel_rsiPeriod: 12, viPeriod: 12, sentinel_strongTrendAdx: 30, sentinel_strongTrendThreshold: 70, sentinel_choppyTrendAdx: 23, sentinel_choppyTrendThreshold: 85, sentinel_rsiOverextendedLong: 78, sentinel_rsiOverextendedShort: 22, sentinel_stPeriod: 12, sentinel_stMultiplier: 3, sentinel_bbwSqueezeThreshold: 0.0035, sentinel_emaFastPeriod: 21, sentinel_emaSlowPeriod: 50, sentinel_emaDistanceVetoThreshold: 1.8, sentinel_srZoneAtrBuffer: 1.0, sentinel_invalidationCandleLimit: 20, sentinel_rsiMomentumExitLong: 47, sentinel_rsiMomentumExitShort: 53 },
