...
interface TradingConfigActions {
    ...
    setMinRrRatio: (ratio: number) => void;
    ...
    setIsSupertrendConfirmationEnabled: (isEnabled: boolean) => void;
    ...
    setIsHeikinAshiEnabled: (isEnabled: boolean) => void;
    setIsDynamicSizingEnabled: (isEnabled: boolean) => void;
    setIsModelFilterEnabled: (isEnabled: boolean) => void;
    // Complex actions
...
export const TradingConfigProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [minRrRatio, setMinRrRatio] = useState<number>(constants.MIN_RISK_REWARD_RATIO);
    ...
    const [isSupertrendConfirmationEnabled, setIsSupertrendConfirmationEnabled] = useState<boolean>(false);
    ...
    const [isHeikinAshiEnabled, setIsHeikinAshiEnabled] = useState<boolean>(false);
    const [isDynamicSizingEnabled, setIsDynamicSizingEnabled] = useState<boolean>(true);
    const [isModelFilterEnabled, setIsModelFilterEnabled] = useState<boolean>(true);
    ...
    const stateValue = useMemo(() => ({
        executionMode, tradingMode, selectedPairs, allPairs, isPairsLoading, leverage, marginType, chartTimeFrame, selectedAgent, investmentAmount, availableBalance, maxMarginLossPercent, minRrRatio, isInitialRiskVetoEnabled, isHtfConfirmationEnabled, isUniversalProfitTrailEnabled, isMinRrEnabled, invalidationSensitivity, isAgentTrailEnabled, isBreakevenTrailEnabled, isMarketCohesionEnabled, isVwapConfirmationEnabled, isBtcConfirmationEnabled, isBtcCorrelationVetoEnabled, btcConfirmationThreshold, isVolumeFilterEnabled, isAdxFilterEnabled, isExhaustionFilterEnabled, isSmcVetoEnabled, isSrAnalysisEnabled, isCandlestickConfirmationEnabled, isMarketStructureVetoEnabled, isSupertrendConfirmationEnabled, htfTimeFrame, agentParams, htfAgentParams, isApiConnected, walletViewMode, isMultiAssetMode, entryTiming, tradingPairLists, isAdaptiveTpEnabled, aggressiveTrailMode, isMarketBreadthFilterEnabled, isLiquidationFilterEnabled, isConfirmationCandleEnabled, isMomentumConcordanceEnabled, isTradeGuardianEnabled, isHeikinAshiEnabled, isDynamicSizingEnabled, isModelFilterEnabled, maxLeverage, isLeverageLoading, futuresSettingsError, multiAssetModeError
    }), [executionMode, tradingMode, selectedPairs, allPairs, isPairsLoading, leverage, marginType, chartTimeFrame, selectedAgent, investmentAmount, availableBalance, maxMarginLossPercent, minRrRatio, isInitialRiskVetoEnabled, isHtfConfirmationEnabled, isUniversalProfitTrailEnabled, isMinRrEnabled, invalidationSensitivity, isAgentTrailEnabled, isBreakevenTrailEnabled, isMarketCohesionEnabled, isVwapConfirmationEnabled, isBtcConfirmationEnabled, isBtcCorrelationVetoEnabled, btcConfirmationThreshold, isVolumeFilterEnabled, isAdxFilterEnabled, isExhaustionFilterEnabled, isSmcVetoEnabled, isSrAnalysisEnabled, isCandlestickConfirmationEnabled, isMarketStructureVetoEnabled, isSupertrendConfirmationEnabled, htfTimeFrame, agentParams, htfAgentParams, isApiConnected, walletViewMode, isMultiAssetMode, entryTiming, tradingPairLists, isAdaptiveTpEnabled, aggressiveTrailMode, isMarketBreadthFilterEnabled, isLiquidationFilterEnabled, isConfirmationCandleEnabled, isMomentumConcordanceEnabled, isTradeGuardianEnabled, isHeikinAshiEnabled, isDynamicSizingEnabled, isModelFilterEnabled, maxLeverage, isLeverageLoading, futuresSettingsError, multiAssetModeError]);

    const actionsValue: TradingConfigActions = useMemo(() => ({
        setExecutionMode, setTradingMode, setSelectedPairs, setAllPairs, setLeverage, setMarginType, setTimeFrame, setSelectedAgent, setInvestmentAmount, setAvailableBalance, setMaxMarginLossPercent, setMinRrRatio, setIsInitialRiskVetoEnabled, setIsHtfConfirmationEnabled, setIsUniversalProfitTrailEnabled, setIsMinRrEnabled, setInvalidationSensitivity, setIsAgentTrailEnabled, setIsBreakevenTrailEnabled, setIsMarketCohesionEnabled, setIsVwapConfirmationEnabled, setIsBtcConfirmationEnabled, setIsBtcCorrelationVetoEnabled, setBtcConfirmationThreshold, setIsVolumeFilterEnabled, setIsAdxFilterEnabled, setIsExhaustionFilterEnabled, setIsSmcVetoEnabled, setIsSrAnalysisEnabled, setIsCandlestickConfirmationEnabled, setIsMarketStructureVetoEnabled, setIsSupertrendConfirmationEnabled, setHtfTimeFrame, setAgentParams, setHtfAgentParams, setIsApiConnected, setWalletViewMode, setIsMultiAssetMode, setEntryTiming, setIsAdaptiveTpEnabled, setAggressiveTrailMode, setIsMarketBreadthFilterEnabled, setIsLiquidationFilterEnabled, setIsConfirmationCandleEnabled, setIsMomentumConcordanceEnabled, setIsTradeGuardianEnabled, setIsHeikinAshiEnabled, setIsDynamicSizingEnabled, setIsModelFilterEnabled, onSetMultiAssetMode, setFuturesSettingsError, addTradingPairList, updateTradingPairList, deleteTradingPairList
    }), [onSetMultiAssetMode, addTradingPairList, updateTradingPairList, deleteTradingPairList, setExecutionMode, setTradingMode, setSelectedPairs, setAllPairs, setLeverage, setMarginType, setTimeFrame, setSelectedAgent, setInvestmentAmount, setAvailableBalance, setMaxMarginLossPercent, setMinRrRatio, setIsInitialRiskVetoEnabled, setIsHtfConfirmationEnabled, setIsUniversalProfitTrailEnabled, setIsMinRrEnabled, setInvalidationSensitivity, setIsAgentTrailEnabled, setIsBreakevenTrailEnabled, setIsMarketCohesionEnabled, setIsVwapConfirmationEnabled, setIsBtcConfirmationEnabled, setIsBtcCorrelationVetoEnabled, setBtcConfirmationThreshold, setIsVolumeFilterEnabled, setIsAdxFilterEnabled, setIsExhaustionFilterEnabled, setIsSmcVetoEnabled, setIsSrAnalysisEnabled, setIsCandlestickConfirmationEnabled, setIsMarketStructureVetoEnabled, setIsSupertrendConfirmationEnabled, setHtfTimeFrame, setAgentParams, setHtfAgentParams, setIsApiConnected, setWalletViewMode, setIsMultiAssetMode, setEntryTiming, setIsAdaptiveTpEnabled, setAggressiveTrailMode, setIsMarketBreadthFilterEnabled, setIsLiquidationFilterEnabled, setIsConfirmationCandleEnabled, setIsMomentumConcordanceEnabled, setIsTradeGuardianEnabled, setIsHeikinAshiEnabled, setIsDynamicSizingEnabled, setIsModelFilterEnabled, setFuturesSettingsError]);
