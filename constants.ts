...
export const SENTINEL_TIMEFRAME_SETTINGS: Record<string, Partial<AgentParams>> = {
    // Scalping (1m, 3m, 5m): Faster EMAs for scalping trends.
    '1m':  { sentinel_scoreThreshold: 85, sentinel_adxPeriod: 10, sentinel_rsiPeriod: 10, viPeriod: 10, sentinel_strongTrendAdx: 35, sentinel_strongTrendThreshold: 75, sentinel_choppyTrendAdx: 25, sentinel_choppyTrendThreshold: 88, sentinel_rsiOverextendedLong: 70, sentinel_rsiOverextendedShort: 30, sentinel_stPeriod: 8, sentinel_stMultiplier: 2.5, sentinel_bbwSqueezeThreshold: 0.0045, sentinel_emaFastPeriod: 21, sentinel_emaSlowPeriod: 50 },
    '3m':  { sentinel_scoreThreshold: 85, sentinel_adxPeriod: 10, sentinel_rsiPeriod: 10, viPeriod: 10, sentinel_strongTrendAdx: 32, sentinel_strongTrendThreshold: 75, sentinel_choppyTrendAdx: 25, sentinel_choppyTrendThreshold: 88, sentinel_rsiOverextendedLong: 72, sentinel_rsiOverextendedShort: 28, sentinel_stPeriod: 8, sentinel_stMultiplier: 2.5, sentinel_bbwSqueezeThreshold: 0.0040, sentinel_emaFastPeriod: 21, sentinel_emaSlowPeriod: 50 },
    '5m':  { sentinel_scoreThreshold: 80, sentinel_adxPeriod: 12, sentinel_rsiPeriod: 12, viPeriod: 12, sentinel_strongTrendAdx: 30, sentinel_strongTrendThreshold: 70, sentinel_choppyTrendAdx: 23, sentinel_choppyTrendThreshold: 85, sentinel_rsiOverextendedLong: 78, sentinel_rsiOverextendedShort: 22, sentinel_stPeriod: 10, sentinel_stMultiplier: 3, sentinel_bbwSqueezeThreshold: 0.0035, sentinel_emaFastPeriod: 21, sentinel_emaSlowPeriod: 50 },
    // Day Trading (15m, 30m, 1h): Balanced EMAs for intraday trends.
    '15m': { sentinel_scoreThreshold: 75, sentinel_adxPeriod: 14, sentinel_rsiPeriod: 14, viPeriod: 14, sentinel_strongTrendAdx: 28, sentinel_strongTrendThreshold: 68, sentinel_choppyTrendAdx: 22, sentinel_choppyTrendThreshold: 82, sentinel_rsiOverextendedLong: 80, sentinel_rsiOverextendedShort: 20, sentinel_stPeriod: 10, sentinel_stMultiplier: 3, sentinel_bbwSqueezeThreshold: 0.0030, sentinel_emaFastPeriod: 50, sentinel_emaSlowPeriod: 120 },
    '30m': { sentinel_scoreThreshold: 75, sentinel_adxPeriod: 14, sentinel_rsiPeriod: 14, viPeriod: 16, sentinel_strongTrendAdx: 25, sentinel_strongTrendThreshold: 65, sentinel_choppyTrendAdx: 20, sentinel_choppyTrendThreshold: 80, sentinel_rsiOverextendedLong: 80, sentinel_rsiOverextendedShort: 20, sentinel_stPeriod: 10, sentinel_stMultiplier: 3, sentinel_bbwSqueezeThreshold: 0.0028, sentinel_emaFastPeriod: 50, sentinel_emaSlowPeriod: 150 },
    '1h':  { sentinel_scoreThreshold: 70, sentinel_adxPeriod: 14, sentinel_rsiPeriod: 14, viPeriod: 18, sentinel_strongTrendAdx: 25, sentinel_strongTrendThreshold: 65, sentinel_choppyTrendAdx: 20, sentinel_choppyTrendThreshold: 80, sentinel_rsiOverextendedLong: 82, sentinel_rsiOverextendedShort: 18, sentinel_stPeriod: 12, sentinel_stMultiplier: 3, sentinel_bbwSqueezeThreshold: 0.0025, sentinel_emaFastPeriod: 50, sentinel_emaSlowPeriod: 150 },
    // Swing Trading (4h, 1d): Standard EMAs for long-term trends.
    '4h':  { sentinel_scoreThreshold: 65, sentinel_adxPeriod: 18, sentinel_rsiPeriod: 18, viPeriod: 20, sentinel_strongTrendAdx: 22, sentinel_strongTrendThreshold: 60, sentinel_choppyTrendAdx: 18, sentinel_choppyTrendThreshold: 75, sentinel_rsiOverextendedLong: 85, sentinel_rsiOverextendedShort: 15, sentinel_stPeriod: 12, sentinel_stMultiplier: 3.5, sentinel_bbwSqueezeThreshold: 0.0022, sentinel_emaFastPeriod: 50, sentinel_emaSlowPeriod: 200 },
    '1d':  { sentinel_scoreThreshold: 60, sentinel_adxPeriod: 20, sentinel_rsiPeriod: 20, viPeriod: 20, sentinel_strongTrendAdx: 20, sentinel_strongTrendThreshold: 60, sentinel_choppyTrendAdx: 18, sentinel_choppyTrendThreshold: 75, sentinel_rsiOverextendedLong: 85, sentinel_rsiOverextendedShort: 15, sentinel_stPeriod: 12, sentinel_stMultiplier: 3.5, sentinel_bbwSqueezeThreshold: 0.0020, sentinel_emaFastPeriod: 50, sentinel_emaSlowPeriod: 200 },
};
